...
export const ReadinessScoreView: React.FC<ReadinessScoreViewProps> = ({
  ...
  return (
    <div className="w-full select-none">
      {/* Hero Section */}
      <div className="relative w-full min-h-[640px] sm:min-h-[720px] flex items-center justify-center pt-24 sm:pt-28 pb-14 px-4 sm:px-8 overflow-hidden">
              ...
              <div className="flex-1 w-full space-y-4">
                ...
                <div className="p-4 rounded-2xl bg-[#f6f1e8] border border-[#dfd4c4] shadow-2xs">
                  ...
                  <div className="w-full h-2.5 bg-white border border-[#dfd4c4] rounded-full overflow-hidden">
                    <div className="h-full bg-[#0ea5e9] rounded-full transition-all duration-500" style={{ width: `${(readiness.coverageScore / 35) * 100}%` }} />
                  </div>
                ...
                <div className="p-4 rounded-2xl bg-[#f6f1e8] border border-[#dfd4c4] shadow-2xs">
                  ...
                  <div className="w-full h-2.5 bg-white border border-[#dfd4c4] rounded-full overflow-hidden">
                    <div className="h-full bg-[#f59e0b] rounded-full transition-all duration-500" style={{ width: `${(readiness.riskScore / 35) * 100}%` }} />
                  </div>
                  <p className="text-[11px] text-[#64748b] mt-1.5 font-medium">
                ...
                <div className="p-4 rounded-2xl bg-[#f6f1e8] border border-[#dfd4c4] shadow-2xs">
                  ...
                  <div className="w-full h-2.5 bg-white border border-[#dfd4c4] rounded-full overflow-hidden">
                    <div className="h-full bg-[#f43f5e] rounded-full transition-all duration-500" style={{ width: `${(readiness.drillScore / 30) * 100}%` }} />
                  </div>
                  <p className="text-[11px] text-[#64748b] mt-1.5 font-medium">
      ...
      {/* Cards below hero */}
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-8 pb-16 space-y-6">
        {/* Drill History */}
        <div
          style={{
            background: 'linear-gradient(145deg, rgba(255, 255, 255, 0.98) 0%, rgba(254, 250, 244, 0.94) 100%)',
